...
export function handleSummary(data) {
  return {
    [`/${RESULT_DIR}/soak-test-summary.json`]: JSON.stringify(data, null, 2),
    [`/${RESULT_DIR}/soak-test-summary.html`]: htmlReport(data),
    [`/${RESULT_DIR}/soak-test-junit.xml`]: jUnit(data, { name: 'soak-test' }),
